...
Select 
substring(PropertyAddress, 1, Charindex(',', PropertyAddress)) as Address, --going to where the comma is in the string
CHARINDEX(',', PropertyAddress)   -- showing us that at character 19 there is a comma therefore take away 1
from DataCleaning.dbo.nashville_housing
...
Select SoldAsVacant,
Case                                    -- Allows you to specify a condition and specify what you want returned when that condition is met.
...
-- when removing duplicates need to have a way to identify those rows therefore use row number
